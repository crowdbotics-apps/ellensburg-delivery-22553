"""ellensburg_delivery_22553 URL Configuration
...
admin.site.site_header = "Ellensburg Delivery"
admin.site.site_title = "Ellensburg Delivery Admin Portal"
admin.site.index_title = "Ellensburg Delivery Admin"

# swagger
api_info = openapi.Info(
    title="Ellensburg Delivery API",
    default_version="v1",
    description="API documentation for Ellensburg Delivery App",
)
